...
$Host.UI.RawUI.WindowTitle = 'mpware AMD settings'
...
Write-MpwareHeader 'AMD Settings' 'Choose the recommended preset or restore AMD defaults.'
Write-Host " 1.  AMD Settings: On (Recommended)" -ForegroundColor Cyan
Write-Host " 2.  AMD Settings: Default`n" -ForegroundColor White
        while ($true) {
...
exit
        ...
        } } else { Write-Host "Invalid input. Please select 1 or 2." -ForegroundColor Yellow } }
