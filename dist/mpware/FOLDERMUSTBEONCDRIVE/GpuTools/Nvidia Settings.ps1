...
Write-MpwareHeader 'NVIDIA Settings' 'Choose the recommended preset or restore NVIDIA defaults.'
...
Remove-Item "$env:ProgramData\Microsoft\Windows\Start Menu\Programs\7-Zip" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
       ...
       Write-Host " 1.  NVIDIA Settings: On (Recommended)" -ForegroundColor Cyan
       Write-Host " 2.  NVIDIA Settings: Default`n" -ForegroundColor White
       while ($true) {
